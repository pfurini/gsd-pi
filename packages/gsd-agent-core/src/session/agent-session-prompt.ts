...
import { RETRYABLE_ERROR_RE } from "@gsd/pi-coding-agent/core/retryable-error-regex.js";
...
export class AgentSessionPromptModule {
	...
	isRetryableError(message: AssistantMessage): boolean {
		...
		// Retryable provider/transport errors live in a shared module so the live
		// gate and tests consume the same pattern (see retryable-error-regex.ts).
